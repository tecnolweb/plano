...
function listarDados() {
  ...
  if (typeof URLSearchParams !== 'undefined') {
    ...
    document.getElementById('info-data').textContent = dadosFormulario.data;
...
function gerarPDF() {
  ...
  const documento = {
      content: [
          ...
          { text: 'Plano de Aula', style: 'header', alignment: 'center' },
          ...
          { columns: [
            ...
            [
                { text: 'data', style: 'subtitlesHeader' },
                { text: dadosFormulario.data, alignment: 'center' },              
            ],
            [
...

      {
        ...
        "canvas": [
          ...
          { text: '\n' },   
          { text: 'Habilidades da BNCC ' , style: 'subtitles'},
